@extends('layouts.app')
@section('title', 'รายละเอียดการรับจากการเคลม')
@section('content')
    <div class="card" style="margin-top:10px">
        <div class="card-header">
            <h3>รายละเอียดการรับจากการเคลม</h3>
        </div>
        <div class="card-body">
            @if ($errors->any())
                ...
                <tbody>
                    @foreach ($receiptclaimsDetail as $receiptclaimDetail)
                        <tr>
                            ...
                            <td>
                                <a href="{{url('/edit-receiptclaims_detail/'.$receiptclaimDetail->idReceivingClaimDetail.'/receiptclaim/'.$idReceiptClaim)}}" class="btn btn-light">แก้ไข</a>
